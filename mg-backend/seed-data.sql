...
INSERT INTO members (first_name, last_name, email, phone, date_of_birth, belt_rank, stripes, last_promotion_date, payment_class, payment_status, active, avatar_url) VALUES 
-- Active paying members with different payment classes
('João', 'Silva', 'joao.silva@email.com', '+1-555-0101', '1990-05-15', 'blue', 2, '2024-06-01', 'evenings', 'paid', true, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face'),
('Maria', 'Santos', 'maria.santos@email.com', '+1-555-0102', '1995-03-20', 'blue', 4, '2024-08-15', 'both', 'paid', true, 'https://i.pinimg.com/originals/9a/4b/aa/9a4baae65a700634f6c2d2e0e52aa650.jpg'),
('Carlos', 'Oliveira', 'carlos.oliveira@email.com', '+1-555-0103', '1988-12-10', 'purple', 1, '2024-01-20', 'mornings', 'paid', true, 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face'),

-- Trial and overdue members
('Ana', 'Costa', 'ana.costa@email.com', '+1-555-0104', '1992-07-08', 'white', 0, NULL, 'evenings', 'trial', true, 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face'),
('Roberto', 'Ferreira', 'roberto.ferreira@email.com', '+1-555-0105', '1985-11-22', 'blue', 3, '2023-12-15', 'both', 'overdue', true, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face'),
...
('Pedro', 'Almeida', 'pedro.almeida@email.com', '+1-555-0107', '1991-04-18', 'white', 1, '2024-05-20', 'coupon', 'paid', true, 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&crop=face'),

-- Advanced belts
('Professor', 'Anderson', 'prof.anderson@email.com', '+1-555-0108', '1980-01-12', 'black', 3, '2020-08-01', 'both', 'paid', true, 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop&crop=face'),
('Instructor', 'Martinez', 'coach.martinez@email.com', '+1-555-0109', '1987-06-25', 'brown', 2, '2023-03-15', 'both', 'paid', true, 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&h=150&fit=crop&crop=face'),
